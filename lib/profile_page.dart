...
// ৩. প্রিমিয়াম ব্যাজের জন্য ডাইনামিক লিঙ্ক
              ...
              children: [
                ...
                Expanded(
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        // 🔥 কন্ডিশন: শুধুমাত্র এজেন্ট হলেই কার্ডটি দেখাবে
                        if (isAgent)
                          Padding(
                            padding: const EdgeInsets.symmetric(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                gradient: const LinearGradient(
                                  colors: [
                                    Color.fromARGB(255, 246, 4, 4),
                                    Color.fromARGB(255, 252, 12, 3)
                                  ],
  ...
  Widget _buildDiamondOption(String amount, String price) {
    return Padding(
      padding: const EdgeInsets.symmetric(
          horizontal: 15, vertical: 8), // বক্সগুলোর মাঝে ফাঁকা জায়গা
      child: InkWell(
        onTap: () {
          Navigator.pop(context);
          _showPaymentMethods();
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(15),
                    border:
                        Border.all(color: Colors.blueAccent.withOpacity(0.1)),
                  ),
                  child: Text(
                    price,
                    style: const TextStyle(
  ...
  Widget _buildMyFramesTab() {
   int currentLevel = getVipLevel();
    ...
    if (hasFreeFrame && !isPremiumExpired) {
      myAvailableFrames.add({"name": "Premium Frame", "url": premiumFrameUrl});
    }
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        // আপনার activeFrameUrl এর সাথে মিলে কি না চেক
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  // ✅ লজিক: নতুনটা PICK করলে পুরাতনটা অটোমেটিক রিপ্লেস হবে (Firebase এ শুধু activeFrame আপডেট হবে)
