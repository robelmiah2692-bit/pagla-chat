...
class _VoiceRoomState extends State<VoiceRoom> {
 ...
 // এই ভেরিয়েবলগুলো ক্লাসের ওপরের দিকে যোগ করুন
  ...
  void initState() {
    ...
    // বিল্ড ফিক্স: এখানে app এবং databaseURL সঠিকভাবে দেওয়া হয়েছে
  ...
  void sitOnSeat(int index) async {
    ...
    try {
      ...
      // বিল্ড ফিক্স: এখানেও databaseURL এবং app সঠিকভাবে বসানো হয়েছে
      ...
      if (currentSeatIndex != -1) {
        await dbRef.ref('rooms/${widget.roomId}/seats/$currentSeatIndex').remove();
      }

      final seatRef = dbRef.ref('rooms/${widget.roomId}/seats/$index');
